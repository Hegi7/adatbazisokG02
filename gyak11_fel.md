...
insert into szemely (nev, szulev, foglalkozas) values ('Nagy Ivó', 1999, 'diák');
insert into szemely (nev, szulev, foglalkozas) values ('Tóth Ottó', 1980, 'pincér');
...
select nev
from szemely
where foglalkozas = 'pincér' OR foglalkozas = 'lakatos';
*/ //nem szabványos, de elfogadható

select nev
from szemely
where foglalkozas IN('pincér', 'lakatos');
```
